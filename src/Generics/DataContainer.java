...
public class DataContainer<type> {
    ...
    // Напишите обобщенный (шаблонный) класс DataContainer,
    // который представляет контейнер для хранения элементов разных типов данных.
    // Этот контейнер должен поддерживать добавление элементов, получение элемента по индексу,
    // удаление элемента по индексу, поиск элемента в контейнере и получение всех элементов.
